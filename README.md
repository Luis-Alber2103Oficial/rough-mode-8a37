...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/rough-mode-8a37)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rough-mode-8a37
```

A live public deployment of this template is available at [https://rough-mode-8a37.templates.workers.dev](https://rough-mode-8a37.templates.workers.dev)
